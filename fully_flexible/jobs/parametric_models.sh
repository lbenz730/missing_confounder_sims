...
#SBATCH -o logs/models/log_parametric.stdout_%a ## STDOUT 
#SBATCH -e logs/models/log_parametric.stderr_%a ## STDERR
...
Rscript estimate_nuisance_fx_parametric.R $SLURM_ARRAY_TASK_ID
